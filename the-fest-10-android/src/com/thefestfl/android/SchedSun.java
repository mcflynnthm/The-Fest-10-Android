...
public class SchedSun extends ListActivity implements OnItemClickListener {
	Context mCtx;
	String[] shows;
	int[] pos;
...
//	        	if (beghr > 12) beghr = beghr - 12;
				...
				if(f.getString(4).equals("1")) shows[count] = shows[count]+ " (acoustic)";
