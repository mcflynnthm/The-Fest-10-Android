...
//	private static final String TAG = "FestDBAdapter";
    ...
    public Cursor fetchDateShows(int day){
    	String date = null;
    	switch(day){
    	case 1: date = "2011-10-28"; break;
    	case 2: date = "2011-10-29"; break;
    	case 3: date = "2011-10-30"; break;
    	}
    ...
    public Cursor fetchShows(String name){
    	return FestDb.query(FESTDB_TABLE, new String[] {KEY_DATE, KEY_VENUE, KEY_ACOUSTIC, KEY_DURATION, KEY_ID}, KEY_NAME+"='"+name+"'", null, null, null, null);
    }
